...
INSERT INTO app_user(address_id, company_info, email, name, password, phone, profession, surname, username,company_id)VALUES (2, 'adsa', 'mika@gmail.com', 'Mika', '$2a$10$eO5z6Ul6K5vQdtZYRj1YtuAMe.TOoZCKuuFHasGuSMV9/EmnSQ1qO', '225-883', 'apotekar', 'Mikic', 'mika',1);
INSERT INTO app_user(address_id, company_info, email, name, password, phone, profession, surname, username,company_id)VALUES (3, 'adsa', 'nikola@gmail.com', 'Nikola', '$2a$10$eO5z6Ul6K5vQdtZYRj1YtuAMe.TOoZCKuuFHasGuSMV9/EmnSQ1qO', '225-883', 'apotekar', 'Nikolic', 'nidza',1);
