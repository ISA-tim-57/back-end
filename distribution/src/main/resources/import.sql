...
INSERT INTO user(address_id, company_info, email, name, password, phone, profession, surname, username)VALUES (1, 'adsa', 'user@gmail.com', 'Pera', '12345', '225-883', 'apotekar', 'Peric', 'pere');